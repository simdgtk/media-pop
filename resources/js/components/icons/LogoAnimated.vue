<template>
    <svg viewBox="0 0 342 313" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M342 0H0V313H342V0Z" :fill="color1" class="fond" />
        <path d="M129.46 247.86H209.96V276.07H129.46V247.86Z" :fill="color2" class="traverse" />
        <path d="M212 242H318.58V282.21H212V242Z" :fill="color1" class="cache-traverse"
        ...
        <path class="letter-small-O"
            ...
            :fill="color2" />
        <path class="letter-bas-P2" d="M267.91 312.72V231.02H219V312.72H267.91Z" :fill="color2" />
        ...
        <path class="letter-bas-P1" :class="{ 'animate': isAnimating }"
            d="M49.9098 312.72V247.72H1.00977V312.72H49.9098Z" :fill="color2" />
    </svg>
